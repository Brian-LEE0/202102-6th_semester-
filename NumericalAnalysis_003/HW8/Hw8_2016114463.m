...
yyb = spline(xb,yb,xx);
yyc = spline(xc,yc,xx);
yyna = natspline(xa,ya,xx);
yynb = natspline(xb,yb,xx);
yync = natspline(xc,yc,xx);

yr = y(xx);

figure("name","spline a","NumberTitle","off");
plot(xa,ya,'o',xx,yya,xx,yr,'--')
figure("Name","natspline a","NumberTitle","off");
plot(xa,ya,'o',xx,yyna,xx,yr,'--')

figure("name","spline b","NumberTitle","off");
plot(xb,yb,'o',xx,yyb,xx,yr,'--')
figure("name","natspline b","NumberTitle","off");
plot(xb,yb,'o',xx,yynb,xx,yr,'--')

figure("name","spline c","NumberTitle","off");
plot(xc,yc,'o',xx,yyc,xx,yr,'--')
figure("name","natspline c","NumberTitle","off");
plot(xc,yc,'o',xx,yync,xx,yr,'--')
